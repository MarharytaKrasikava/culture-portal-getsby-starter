const authors = {
  KorshSablin: {
    ...
    listOfWorks: [
      { id: '1', film: 'В огне рожденная', date: '1930' },
      { id: '2', film: 'Первый взвод', date: '1933' },
      { id: '3', film: 'Моя любовь', date: '1940' },
      { id: '4', film: 'Константин Заслонов', date: '1949' },
      { id: '5', film: 'Кто смеётся последним', date: '1954' },
      { id: '6', film: 'Красные листья', date: '1958' },
      { id: '7', film: 'Первые испытания', date: '1960' },
      { id: '8', film: 'Москва - Генуя', date: '1964' },
      { id: '9', film: 'Крушение империи', date: '1970' },
    ],
    timeline: [
